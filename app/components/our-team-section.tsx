    ...
    const teamMembers = [
        {
            id: 1,
            name: "Toan Truong",
            portrait: "/images/toan_portrait.png",
        ...
        },
        {
            id: 3,
            name: "Trung",
            portrait: "/images/trung_portrait.png",
        ...
        },
        {
            id: 6,
            name: "Tristan Nguyen",
            portrait: "/images/tristan_portrait.png",
                        ...
                        <div key={member.id} className="group relative transition-all duration-300">
                            ...
                            <div className="relative z-10 bg-white border-2 border-black rounded-[4px] overflow-hidden h-96">
                                ...
                                <div className="p-4 h-32 flex flex-col justify-between">
                                    <div>
                                        <h3 className="font-bold text-base sm:text-lg md:text-lg lg:text-xl  text-purple-700">{member.name}</h3>
                                        <p className="text-sm sm:text-base md:text-base lg:text-[18px] mt-1 line-clamp-2">{member.role}</p>
                                    </div>
                                    {member.linkedin && (
                                        <Link 
