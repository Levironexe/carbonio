      ...
      <main className='w-full p-2 sm:p-4 md:p-6 px-4 sm:px-6 md:px-10'>
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='w-full flex flex-col lg:flex-row gap-4 sm:gap-6 md:gap-8 text-black'>
            <div className='w-full lg:flex-1 flex flex-col justify-between rounded-[4px] border-2 border-carbon shadow-carbon shadow-lg hover:shadow-md pt-6 sm:pt-8 md:pt-12 hover:scale-[1.02] transition-all duration-200'>
              <div>
            ...
            <div className='w-full lg:flex-[2] flex flex-col gap-4 sm:gap-6 md:gap-8'>
              <div className='flex flex-col md:flex-row gap-4 sm:gap-6 md:gap-8'>
                <div className='w-full md:flex-1 flex flex-col justify-between rounded-[4px] border-2 border-carbon shadow-carbon shadow-lg hover:shadow-md py-6 sm:py-8 md:py-12 hover:scale-[1.02] transition-all duration-200'>
                  <div>
                ...
                <div className='w-full md:flex-1 flex flex-col justify-between rounded-[4px] border-2 border-carbon shadow-carbon shadow-lg hover:shadow-md pt-6 sm:pt-8 md:pt-12 hover:scale-[1.02] transition-all duration-200'>
                  <div>
